...
DEFAULT_RF_CONFIG_PATH = "./config/rf_lvh_norm_other.json"
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Random Forest for 3-class: NORM vs LVH vs OTHERS"
    )
    parser.add_argument(
        "--lvh-dir",
        type=str,
    ...
    parser.add_argument(
        "--others-dir",
        type=str,
        default="./results/OTHERS_exclude_LVH_pure_NORM",
        help="Directory containing OTHERS data (label 2)",
    )
    parser.add_argument(
        "--out-dir",
        type=str,
        default="./results/model/lvh_norm_other_rf",
